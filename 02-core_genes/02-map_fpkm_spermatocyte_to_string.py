...
if __name__ == '__main__':
    ...
    # Load FPKM
    tar_HS = tarfile.open('../1-diff-gene-exp/data/FPKM/HS/HS_Spermatocyte.tar.gz', "r:gz")
    df_HS = pd.concat(
        [
    ...
    # Load FPKM
    tar_MM = tarfile.open('../1-diff-gene-exp/data/FPKM/MM/MM_Spermatocyte.tar.gz', "r:gz")
    df_MM = pd.concat(
        [
