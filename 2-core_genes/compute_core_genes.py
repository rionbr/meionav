...
if __name__ == '__main__':
    ...
    # Load Species Files
    df_HS = pd.read_csv('results/genes_HS.csv', index_col='id_string')
    df_MM = pd.read_csv('results/genes_MM.csv', index_col='id_string')
    df_DM = pd.read_csv('results/genes_DM.csv', index_col='id_string')
    ...
    print("> Exporting")
    # Export this too
    df_SG.to_csv('results/all_meiotic_genes.csv')
    ...
    df_SSG_3.to_csv('results/core_meiotic_genes.csv')
