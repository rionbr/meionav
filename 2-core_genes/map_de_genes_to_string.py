...
if __name__ == '__main__':
    ...
    for maxFDR in [0.01, 0.05]:
        ...
        #
        print('Mapping HS')
        rCSVFileUp = "../1-diff-gene-exp/results/HS/DE/HS_DE_UpCyte_vs_Gonia-{maxFDR:s}.csv".format(maxFDR=maxFDR_str)
        rCSVFileDown = "../1-diff-gene-exp/results/HS/DE/HS_DE_DownCyte_vs_Tid-{maxFDR:s}.csv".format(maxFDR=maxFDR_str)
        ...
        wCSVFileHS = "results/HS/genes_HS-{maxFDR:s}.csv".format(maxFDR=maxFDR_str)
        ...
        #
        print('Mapping MM')
        rCSVFileUp = "../1-diff-gene-exp/results/MM/DE/MM_DE_UpCyte_vs_Gonia-{maxFDR:s}.csv".format(maxFDR=maxFDR_str)
        rCSVFileDown = "../1-diff-gene-exp/results/MM/DE/MM_DE_DownCyte_vs_Tid-{maxFDR:s}.csv".format(maxFDR=maxFDR_str)
        ...
        wCSVFileMM = "results/MM/genes_MM-{maxFDR:s}.csv".format(maxFDR=maxFDR_str)
