...
# Input Path
ip="/home/casci/rionbr/spermnet/05-data-analysis/gephi-plotting/results/graphml"
# Output Path
op="/home/casci/rionbr/spermnet/05-data-analysis/gephi-plotting/results/forceatlas2"
...
## Loop celltypes
for celltype in "spermatocyte" "spermatogonia" "enterocyte"
do
	## Loop Layers
	...
	do
		...
		# input/output dir
		inputdir="$ip/$celltype/"
		outputdir="$op/$celltype/"
