...
public class PlotNetSingleMod {
    ...
    public static void main(String[] args) throws IOException {
        ...
        addArg("node-size", "Size of nodes.", true);
        ...
        // Edge Thickness
        Float node_size = 15.0f;
        if (getArg("node-size") != null) {
            node_size = Float.parseFloat(getArg("node-size"));
        }

        // Edge Thickness
        Double edge_thickness = 1.0;
        if (getArg("edge-thickness") != null) {
            edge_thickness = Double.parseDouble(getArg("edge-thickness"));
        }

        // Edge Opacity
        Double edge_opacity = 100.0;
        if (getArg("edge-opacity") != null) {
            edge_opacity = Double.parseDouble(getArg("edge-opacity"));
        }

        // Highlight attribute
        String node_highlight = null;
        if (getArg("node-highlight") != null) {
        ...
        */
        ...
        // Node
        previewModel.getProperties().putValue(PreviewProperty.NODE_BORDER_WIDTH, 1.0f);
        previewModel.getProperties().putValue(PreviewProperty.NODE_BORDER_COLOR, new DependantColor(Color.decode("#000000"))); //black
        ...
        previewModel.getProperties().putValue(PreviewProperty.EDGE_OPACITY, edge_opacity);
        previewModel.getProperties().putValue(PreviewProperty.EDGE_THICKNESS, edge_thickness);
