...
if __name__ == '__main__':
    ...
    wMLTFile = 'results/clf-phenotype-metric/{layer:s}/ml-{celltype:s}-{layer:s}-auc.csv.gz'.format(celltype=celltype, layer=layer)
    ...
    print(dfF)
    wMLFFile = 'results/clf-phenotype-metric/{layer:s}/ml-{celltype:s}-{layer:s}-features.csv.gz'.format(celltype=celltype, layer=layer)
    ...
    print(dfR)
    wMLCFile = 'results/clf-phenotype-metric/{layer:s}/ml-{celltype:s}-{layer:s}-clf.csv.gz'.format(celltype=celltype, layer=layer)
