...
if __name__ == '__main__':
    ...
    parser.add_argument("--celltype", default='enterocyte', type=str, choices=['spermatocyte', 'enterocyte'], help="Cell type. Must be either 'spermatocyte' or 'enterocyte'. Defaults to spermatocyte")
