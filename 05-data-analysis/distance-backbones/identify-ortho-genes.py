...
if __name__ == '__main__':
    ...
    # Results
    #
    df['is_conserved'] = True
    df['is_core'] = df.index.isin(is_core)
    df['is_ortho_metric_nodes'] = df.index.isin(is_ortho_metric_nodes)
    #
    # Export
    df.to_csv('results/identity-{layer:s}-conserved-genes-ortho.csv'.format(layer=layer))
