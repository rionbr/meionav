...
if __name__ == '__main__':
    ...
    eb = ax_fert.errorbar(df['mean fert-rate'], range(0, len(df)), xerr=df['std fert-rate'], lw=0,
                          ecolor='#7f7f7f', elinewidth=0.6, capsize=0.6,
                          marker='.', markersize=4.0,
                          markeredgecolor='#7f7f7f', markeredgewidth=0.0,
    ...
    #
    fig.savefig('images-joana/img-core_DM_screened-vertical-rnai-{rnai:s}.pdf'.format(rnai=str(rnai)))
